...
public class IssueController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> cretaeIssue(@RequestHeader("Authorization") String token, @RequestBody Issue issue) {
        try {
            ...
            String errorMsg = "Invalid json error in issue creation: " + jsonException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (NullPointerException nullPointerException) {
            String errorMsg = "Null pointer in issue creation: " + nullPointerException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    @PutMapping("/edit/{id}")
    public ResponseEntity<Object> updateIssue(@RequestHeader("Authorization") String token, @PathVariable("id") long id, @RequestBody Issue issue) {
        ...
        try {
            ...
            if (!verifiedAuthObject.has("error")) {
                ...
                if (issueData.isPresent()) {
                    ...
                    String errorMsg = "Issue is not available.";
            ...
            String errorMsg = "Null pointer in issue update: " + nullPointerException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Object> getAllIssues(@RequestHeader("Authorization") String token) {
        try {
            ...
            String errorMsg = "Null pointer in getting all issues: " + nullPointerException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Object> getStateData(@RequestHeader("Authorization") String token) {
        ...
        try {
            ...
            String errorMsg = "IOException in getting percentages: " + ioException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (InterruptedException interruptedException) {
            String errorMsg = "InterruptedException in getting percentages: " + interruptedException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (JSONException jsonException) {
            String errorMsg = "Invalid json error in getting percentages: " + jsonException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (NullPointerException nullPointerException) {
            String errorMsg = "Null pointer getting percentages: " + nullPointerException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Object> getAllIssuesOfState(@RequestHeader("Authorization") String token, @PathVariable String issueState) {
        ...
        try {
            ...
            String errorMsg = "IOException in getting issues by state: " + ioException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (InterruptedException interruptedException) {
            String errorMsg = "InterruptedException in getting issues by state: " + interruptedException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (JSONException jsonException) {
            String errorMsg = "Invalid json error in getting issues by state: " + jsonException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (NullPointerException nullPointerException) {
            String errorMsg = "Null pointer in getting issues by state: " + nullPointerException;
            log.info(errorMsg);
            return new ResponseEntity<>(errorMsg, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public void findUserInDB(JSONObject tokenVerification) {
